...
interface DailyViolationChartFilterProps {
  sourceType: string;
...
export default function DailyViolationChartFilter({
  sourceType,
  setSourceType,
  startDate,
  setStartDate,
  ...
  onReset,
  chartRef,
}: DailyViolationChartFilterProps) {
        ...
        <select
          ...
          onChange={(e) => {
            ...
            if (typeof window !== "undefined") {
              localStorage.setItem("dailyViolationSourceType", e.target.value);
            }
          }}
