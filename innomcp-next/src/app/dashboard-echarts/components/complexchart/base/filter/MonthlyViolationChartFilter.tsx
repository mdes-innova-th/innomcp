...
interface MonthlyViolationChartFilterProps {
  sourceType: string;
...
export default function MonthlyViolationChartFilter({
  sourceType,
  setSourceType,
  startMonth,
  setStartMonth,
  ...
  onReset,
  chartRef,
}: MonthlyViolationChartFilterProps) {
