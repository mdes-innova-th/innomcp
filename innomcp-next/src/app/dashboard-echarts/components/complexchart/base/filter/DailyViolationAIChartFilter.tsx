...
interface DailyViolationAIChartFilterProps {
  sourceType: string;
...
export default function DailyViolationAIChartFilter({
  sourceType,
  setSourceType,
  startDate,
  setStartDate,
  ...
  onReset,
  chartRef,
}: DailyViolationAIChartFilterProps) {
