...
ออกแบบ UI ให้เป็น agent workspace ที่สะอาด ใช้งานง่าย และให้ความรู้สึกว่ามีระบบกำลังทำงานอยู่เบื้องหลังอย่างโปร่งใส ห้ามทำหน้าตาเลียนแบบผลิตภัณฑ์ใดแบบหนึ่งต่อหนึ่ง ให้สร้าง design system ใหม่ของเราเอง
