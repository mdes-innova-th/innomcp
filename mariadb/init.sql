-- ================================
-- INNOMCP Database Initialization
-- Comprehensive Keyword Training Seed Data
-- ================================

USE innomcp;

-- Create keyword_training table if not exists
...
('รากที่สอง', 'calculator', 'math', 'th', 0.85, 'medium', 'exact', 'manual'),
...
-- QRCODE CATEGORY
-- ================================
('qrcode', 'qrcode', 'qr', 'en', 1.00, 'critical', 'exact', 'manual'),
...
-- Ensure NASA category has keywords (GodTierRouter uses category="nasa")
INSERT INTO keywords (category, keyword) VALUES
('nasa', 'nasa'),
('nasa', 'ดาวเทียม'),
('nasa', 'อวกาศ'),
('nasa', 'ภาพถ่ายดาวเทียม'),
('nasa', 'apod'),
('nasa', 'astronomy picture');

-- Ensure WorldBank category has keywords (GodTierRouter uses category="worldbank")
INSERT INTO keywords (category, keyword) VALUES
...
('worldbank', 'gdp'),
('worldbank', 'เงินเฟ้อ'),
('worldbank', 'อัตราว่างงาน'),
('worldbank', 'เศรษฐกิจโลก');
...
-- Grant permissions for jlapps user
GRANT ALL PRIVILEGES ON innomcp.* TO 'jlapps'@'%' IDENTIFIED BY PASSWORD '$2b$10$bROxepaG8aOM9xiou6h5qu/Twl3yHbD6zMaMb8faIyQZYMNCTIVxC';
FLUSH PRIVILEGES;