...
export function registerWebdTools(mcpserver: McpServer) {
  mcpserver.registerTool(
    "webdTool_group",
    {
      ...
      description: `หน้าที่: คืนสถิติจำนวนเว็บไซต์/URL แยกตามกลุ่มความผิด (category/group)
ใช้เมื่อ:
- มีคำว่า "กลุ่ม" หรือ "หมวด" หรือ "ประเภท" หรือชื่อความผิด ในคำขอของผู้ใช้
- ต้องการสถิติแยกตามกลุ่มความผิดโดย กรองตามวันที่ มีคำร้อง/ไม่มีคำร้อง หรือมีคำสั่งศาล/ไม่มีคำสั่งศาล
ไม่ใช้เมื่อ: 
- ไม่มีคำว่า "กลุ่ม" หรือ "หมวด" หรือ "ประเภท" หรือชื่อความผิด ในคำขอของผู้ใช้
...
ใช้เมื่อ:
- มีคำว่า "แพลตฟอร์ม" หรือ "platform" หรือชื่อเว็บไซต์ หรือชื่อแพลตฟอร์มในคำขอของผู้ใช้
- ต้องการทราบการกระจายตัวของรายการตามแพลตฟอร์มเพื่อวิเคราะห์ช่องทางที่พบปัญหามากที่สุด
ไม่ใช้เมื่อ:
- ไม่มีคำว่า "แพลตฟอร์ม" หรือ "platform" หรือชื่อเว็บไซต์ หรือชื่อแพลตฟอร์ม ในคำขอของผู้ใช้
...
ใช้เมื่อ:
- มีคำว่า "ประเทศ" หรือ "country" หรือ "ที่ตั้ง" หรือ "ที่อยู่" หรือ "ที่ไหน" หรือชื่อประเทศ ในคำขอของผู้ใช้ 
- ต้องการวิเคราะห์การกระจายตามประเทศเพื่อตรวจสอบแหล่งที่มาของโดเมน/URL
ไม่ใช้เมื่อ: 
- ไม่มีคำว่า "ประเทศ" หรือ "country" หรือ "ที่ตั้ง" หรือ "ที่อยู่" หรือ "ที่ไหน" หรือชื่อประเทศ ในคำขอของผู้ใช้
