...
function resolveThaiGeoLocal(rawQuery: string): { text: string; geoIntent: string; canonicalQuery: string } | null {
  ...
  const placeMatch = t.match(/(กรุงเทพ(?:มหานคร)?|เชียงใหม่|เชียงราย|ขอนแก่น|นครราชสีมา|โคราช|ภูเก็ต|สงขลา|หาดใหญ่|อุบล(?:ราชธานี)?|สุราษฎร์ธานี|นครศรีธรรมราช|พิษณุโลก|ชลบุรี|กาญจนบุรี|อุดรธานี|บุรีรัมย์|สุรินทร์|พัทยา|แม่กลอง|เกาะสมุย|กทม|ลำพูน|ลำปาง|น่าน|พะเยา|แพร่|แม่ฮ่องสอน|หัวหิน|ปากช่อง|เขาใหญ่|ศรีราชา|บางรัก|ปทุมวัน|สาทร|สีลม|จตุจักร|บางนา|ดอนเมือง|หลักสี่|อยุธยา|แปดริ้ว|อุดร|ปาย|เบตง|แม่สอด|แม่สาย|เชียงแสน|แม่ริม|รังสิต|ลำลูกกา|ปากเกร็ด|บางบัวทอง)/);
